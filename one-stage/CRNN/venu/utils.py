...
tf.app.flags.DEFINE_string('checkpoint_dir', './checkpoint/smalldata/wiki', 'the checkpoint dir') #edit
tf.app.flags.DEFINE_float('initial_learning_rate', 1e-4, 'inital lr')

tf.app.flags.DEFINE_integer('image_height', 60, 'image height') #edit
tf.app.flags.DEFINE_integer('image_width', 256, 'image width') #edit
tf.app.flags.DEFINE_integer('image_channel', 1, 'image channels as input')
tf.app.flags.DEFINE_integer('max_stepsize', 10, 'max lenth of sequence')#edit
...
tf.app.flags.DEFINE_integer('num_epochs', 600, 'maximum epochs') #edit
...
tf.app.flags.DEFINE_string('train_dir', '/home/abc/xcx/crnn_500/wiki/train/', 'the train data dir')
tf.app.flags.DEFINE_string('val_dir', '/home/abc/xcx/crnn_500/wiki/val/', 'the val data dir')
tf.app.flags.DEFINE_string('infer_dir', '/home/abc/xcx/crnn_500/wiki/test/', 'the infer data dir') #edit
