...
def train(train_record_file,
    ...
    with slim.arg_scope(alexnet.alexnet_v2_arg_scope()):
        out, end_points = alexnet.alexnet_v2(inputs= input_images,num_classes=label_nums,is_training=is_training,dropout_keep_prob=keep_prob)
    ...
    with tf.Session() as sess:
        ...
        # saver.restore(sess,"models/lenet/baidu/best_models_19000_0.8031.ckpt")
...
if __name__ == '__main__':
    scheme = 'random'
    train_record_file='dataset/'+ scheme +'/'+ scheme +'_train224.tfrecords'
    val_record_file='dataset/'+ scheme +'/'+ scheme +'_val224.tfrecords'
    ...
    val_log_step=1000
    snapshot=2000
    model_file = "models/alexnet/"+ scheme
    if not os.path.exists(model_file):
        os.mkdir(model_file)
    snapshot_prefix = 'models/alexnet/'+ scheme +'/model.ckpt'
